...
export interface IUseToggleDropdown {
  isDropdownOpen: boolean;
  toggleDropdown: () => void;
  dropdownRef: React.RefObject<HTMLDivElement>;
  toggleDropdownForList: (params: { idToggle: number; isOpen: boolean }) => void;
  isDropdownList: { isOpen: boolean; id: number | null };
  setIsDropdownOpen: React.Dispatch<React.SetStateAction<boolean>>;
  closeDropDown: () => void;
}

export const useToggleDropdown = (props: Props = {}): IUseToggleDropdown => {
