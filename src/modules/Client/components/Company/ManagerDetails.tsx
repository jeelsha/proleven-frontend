                ...
                managerInfo?.manager?.user && (
                  ...
                  >
                    {companyInfo?.company_manager &&
                      companyInfo?.company_manager.length > 1 && (
                        <Button
                          className={`flex justify-between items-center w-full ${openIndex === index ? 'mb-7' : ''
                            }`}
                    ...
                    <div
                      className={`flex flex-wrap justify-between gap-x-8 gap-y-5 w-full transition-all ${openIndex === index ? '' : 'hidden'
                        }`}
                    >
                      <CardDetails
