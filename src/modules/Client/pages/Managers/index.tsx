...
const ClientManagers = () => {
  ...
  const [getAllCompanyManagers, { isLoading: managerExportLoader }] = useAxiosGet();
  ...
  updateTitle(t(tabs?.[activeTab]?.title))
  useEffect(() => {
    const urlToCall =
  ...
  return (
    <>
      ...
      <PageHeader small text={t('SideNavigation.client.managerTitle')} isScroll>
