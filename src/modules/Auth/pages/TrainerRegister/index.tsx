...
import { fileInputEnum, Option } from 'components/FormElement/types';
              ...
              <Form>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <InputField
                    ...
                    label={t('UserProfile.settings.firstNamePlaceHolder')}
                    name="first_name"
                  />
                  <InputField
                    ...
                    label={t('UserProfile.settings.lastNamePlaceHolder')}
                    name="last_name"
                  />
                  <DropZone
