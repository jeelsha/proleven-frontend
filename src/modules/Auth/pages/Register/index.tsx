...
const Register = () => {
  ...
  const [search, setSearch] = useState(registerFormInitialValue?.company_name ?? '');
      ...
      case 1:
        return (
          <RegisterCompanyInfo
            ...
            atecoCodeList={atecoCodeList}
            setAtecoCodeList={setAtecoCodeList}
          />
        );
      case 2:
        return (
  ...
  return (
    <>
      <RegisterModal modal={captchaModal} />
