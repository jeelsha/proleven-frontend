...
export const FundedByChoices = () => {
  const { t } = useTranslation();
  return [
    {
      label: t('CoursesManagement.CreateCourse.customerManagement'),
      value: FundedBy.ClientAddress,
    },
    {
      label: t('CoursesManagement.CreateCourse.prolevenManagement'),
      value: FundedBy.ProlevenAcademy,
    },
  ];
};
