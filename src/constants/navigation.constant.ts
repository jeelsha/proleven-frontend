...
export const EXAM_NAVIGATION: { [key: string]: string } = Object.freeze({
  ...
  examForm: '/exam/form/:examSlug/:participateSlug/:language',
...
export const PRIVATE_NAVIGATION = Object.freeze({
  ...
  trainerOrder: {
    currentMonthOrder: {
      view: {
        ...
        feature: FeaturesEnum.TrainerOrder,
        permission: PermissionEnum.View,
      },
    },
    previousMonthOrder: {
  ...
  quotes: {
    ...
    clone: {
      path: '/quotes/clone/:companySlug/:slug',
      feature: FeaturesEnum.Quote,
      permission: PermissionEnum.Update,
    },
    view: {
  ...
  coursesManagement: {
    ...
    attendanceTimeSheet: {
      path: '/courses/company/attendance-timesheet/:courseSlug/:companySlug/:participateSlug',
      feature: FeaturesEnum.CourseInvitations,
      permission: PermissionEnum.View,
    },
    courseCompanyList: {
